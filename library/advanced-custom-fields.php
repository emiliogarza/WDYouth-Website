...
if(function_exists("register_field_group"))
{
	register_field_group(array (
		...
		'fields' => array (
			array (
				'key' => 'field_589fceace3823',
				'label' => 'Background Image',
				'name' => 'event_background_image',
				'type' => 'image',
				'instructions' => 'Choose the Background image to put in the heading area',
				'save_format' => 'url',
				'preview_size' => 'thumbnail',
				'library' => 'all',
			),
			array (
				'key' => 'field_589fcee3e3824',
				'label' => 'Logo Image',
				'name' => 'event_logo_image',
				'type' => 'image',
				'instructions' => 'Choose the Image of the Logo',
				'save_format' => 'url',
				'preview_size' => 'thumbnail',
				'library' => 'all',
			),
			array (
				'key' => 'field_589fecfb3b736',
				'label' => 'Tab 1 Title',
				'name' => 'panel1-title',
				'type' => 'text',
				'instructions' => 'Enter the title of the tab',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
				'append' => '',
